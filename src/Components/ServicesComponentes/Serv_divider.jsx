                ...
                <div className="row align-items-center">
                  <div className="col-lg-7 text-center text-lg-left">
                    ...
                    <p className="text-small mb-0">
                      At Association Miniere du Mali, we have been dedicated to excellence in gold mining, refining, and trading for over a century. Your legacy is our commitment.
                    </p>
                  </div>
